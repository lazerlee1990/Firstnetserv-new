            ...
            <Container  fluid style={{width: "100%"}}>
               {/* Full Width Container. Code Below */}
                    ...
                    <Container fluid style={{width: "70%", maxWidth: "1440px"}}>
                        ...
                        <Row>
                            <Col className="textdescription" xxl={6} md={12}><h2>Sound Equitment</h2>
                ...
                <Col className="projectdetails" xxl={6} md={12}><img src="/DJsoundrental.jpg" alt="features" className="top-img flip" /></Col>
            </Container>
        </div>
    )
}
